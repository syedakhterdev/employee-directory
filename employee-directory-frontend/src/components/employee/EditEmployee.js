...
const EditEmployee = (props) => {
  ...
  const [email, setEmail] = useState({
    value: props.selectedEmployee?.email ? props.selectedEmployee.email : "",
  });
  const [designation, setDesignagtion] = useState({
    value: props.selectedEmployee?.designation
      ? props.selectedEmployee.designation
      : "",
  });
  const [title, setTitle] = useState({
    value: props.selectedEmployee?.title ? props.selectedEmployee.title : "Mr",
  });
  ...
  const [firstName, setFirstName] = useState({
    value: props.selectedEmployee?.firstName
      ? props.selectedEmployee.firstName
      : "",
  });
  const [lastName, setLastName] = useState({
    value: props.selectedEmployee?.lastName
      ? props.selectedEmployee.lastName
      : "",
  });
  const [dob, setDob] = useState({
    value: props.selectedEmployee?.dob
      ? props.selectedEmployee.dob
      : "2000-01-01",
  });
  const [gender, setGender] = useState({
    value: props.selectedEmployee?.gender ? props.selectedEmployee.gender : "",
  });
  const [phone, setPhone] = useState({
    value: props.selectedEmployee?.phone ? props.selectedEmployee.phone : "",
  });
...
const mapDispatchToProps = (dispatch) => {
  return {
    onUpdateEmployee: (employee, id) =>
      dispatch(actions.editEmployee(employee, id)),
  };
};
